...
const branches = [
  { name: "Headquarters", address: "Plot No 1282, Road No 64, Jubilee Hills, Hyderabad - 500033", hq: true },
  { name: "KPHB Branch", address: "Flat No 501, Shanth Apartments, KPHB, Hyderabad", hq: false },
  { name: "Vijayawada Branch", address: "Flat No F4, Sai Sudha Apartments, Gayatri Nagar, Vijayawada - 520010", hq: false },
  { name: "Eluru Branch", address: "Opp Dr. Jagannmohan Rao House, MR Pet, Eluru - 534008", hq: false },
  { name: "Guntur Branch", address: "Flat No 12, Sindhuri Apartments, Nalanda Nagar, Guntur", hq: false },
];
      ...
      <section className="section-padding" style={{ background: '#FFFDF8' }}>
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 max-w-6xl mx-auto">
            ...
            <div>
              <ScrollReveal>
                <h2 className="font-display font-light mb-2" style={{ fontSize: 'clamp(28px, 3.5vw, 48px)', color: '#0F0A05' }}>Let's Begin Your Story</h2>
                <p className="font-accent text-[18px] mb-8" style={{ color: '#9B7A2A' }}>Every great match starts with a conversation</p>
                ...
                <div className="space-y-5 mb-8">
                  {[
                    ...
                    <a key={c.label} href={c.href} className="flex items-center gap-4 group">
                      <div className="w-12 h-12 rounded-full flex items-center justify-center shrink-0" style={{ background: '#FBF5EB', border: '1px solid rgba(201,168,76,0.2)' }}>
                ...
                <a
                  ...
                  style={{ height: '56px', background: 'linear-gradient(135deg, #25D366, #1EA952)', borderRadius: '14px', border: 'none' }}
                ...
                <p className="font-body font-light text-[11px] text-center mt-2" style={{ color: '#9B7A2A' }}>Usually responds within 30 minutes</p>

                <div className="mt-6 bg-white rounded-[16px] p-5" style={{ border: '1px solid rgba(201,168,76,0.12)' }}>
                  <h4 className="font-body font-medium text-[13px] tracking-[0.08em] uppercase mb-3" style={{ color: '#5C4510' }}>Office Hours</h4>
            ...
            <ScrollReveal delay={100}>
              <div className="relative overflow-hidden" style={{ background: 'white', borderRadius: '24px', border: '1px solid rgba(201,168,76,0.15)', padding: 'clamp(24px,4vw,44px)', boxShadow: '0 8px 48px rgba(15,10,5,0.08)' }}>
                <div className="absolute top-0 left-0 right-0 h-[2px]" style={{ background: 'linear-gradient(90deg, #C9A84C, #8B2E2E)' }} />
                <h2 className="font-display font-semibold text-[26px] mb-1" style={{ color: '#2C1F10' }}>Send Us a Message</h2>
                <p className="font-body font-light text-[14px] mb-7" style={{ color: '#9B7A2A' }}>We'll get back to you within 4 hours</p>

                {submitted ? (
                  <div className="text-center py-12">
                    <div className="w-14 h-14 mx-auto mb-4 rounded-full flex items-center justify-center" style={{ background: 'rgba(201,168,76,0.1)' }}>
                      <Send className="w-6 h-6" style={{ color: '#C9A84C' }} />
                    </div>
                    <h3 className="font-display font-semibold text-[20px] mb-2" style={{ color: '#0F0A05' }}>Message Sent!</h3>
                    <p className="font-body font-light text-[14px]" style={{ color: '#7A6550' }}>Our team will reach out to you shortly.</p>
                  </div>
                ) : (
                  <form className="space-y-5" onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }}>
                    <div>
                      <label className="font-body text-[12px] tracking-[0.08em] uppercase block mb-2" style={{ color: '#7A6550' }}>Full Name</label>
                      <input type="text" placeholder="Your full name" required style={inputStyle} onFocus={focusHandler} onBlur={blurHandler} />
                    </div>
                    <div>
                      <label className="font-body text-[12px] tracking-[0.08em] uppercase block mb-2" style={{ color: '#7A6550' }}>Phone Number</label>
                      <input type="tel" placeholder="+91 98765 43210" required style={inputStyle} onFocus={focusHandler} onBlur={blurHandler} />
                    </div>
                    <div>
                      <label className="font-body text-[12px] tracking-[0.08em] uppercase block mb-2" style={{ color: '#7A6550' }}>Email Address</label>
                      <input type="email" placeholder="you@email.com" style={inputStyle} onFocus={focusHandler} onBlur={blurHandler} />
                    </div>
                    <div>
                      <label className="font-body text-[12px] tracking-[0.08em] uppercase block mb-2" style={{ color: '#7A6550' }}>I am looking for</label>
                    ...
                    <div>
                      <label className="font-body text-[12px] tracking-[0.08em] uppercase block mb-2" style={{ color: '#7A6550' }}>Message</label>
                      <textarea rows={4} placeholder="Tell us how we can help..." required className="w-full font-body font-light text-[14px] resize-none" style={{ ...inputStyle, height: '120px', padding: '14px 16px' }} onFocus={focusHandler as any} onBlur={blurHandler as any} />
                    </div>
                    <button type="submit" className="w-full font-body text-[14px] font-semibold flex items-center justify-center gap-2 transition-all" style={{
          ...
          {/* Map + Branches — integrated below form */}
          <div className="max-w-6xl mx-auto mt-16">
            <div style={{ borderTop: '1px solid rgba(201,168,76,0.12)', paddingTop: 'clamp(32px,5vw,48px)' }}>
              <ScrollReveal>
              ...
              <ScrollReveal delay={50}>
                <div className="overflow-hidden mb-8" style={{ borderRadius: '20px', border: '1px solid rgba(201,168,76,0.15)', height: 'clamp(200px,30vw,320px)' }}>
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3806.5!2d78.4!3d17.43!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTfCsDI1JzQ4LjAiTiA3OMKwMjQnMDAuMCJF!5e0!3m2!1sen!2sin!4v1600000000000!5m2!1sen!2sin"
                    width="100%" height="100%" style={{ border: 0 }} allowFullScreen loading="lazy"
                    referrerPolicy="no-referrer-when-downgrade" title="Kammavaari Matrimony Office"
                  />
                </div>
              </ScrollReveal>
                ...
                {branches.map((b, i) => (
                  <ScrollReveal key={b.name} delay={i * 60}>
                    <div
                      ...
                      style={{
                        background: b.hq ? 'rgba(201,168,76,0.04)' : 'white',
                        border: `1px solid ${b.hq ? 'rgba(201,168,76,0.3)' : 'rgba(201,168,76,0.12)'}`,
                      ...
                      onMouseLeave={e => { e.currentTarget.style.borderColor = b.hq ? 'rgba(201,168,76,0.3)' : 'rgba(201,168,76,0.12)'; e.currentTarget.style.transform = 'translateY(0)'; }}
                    >
